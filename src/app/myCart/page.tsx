...
export default function Cart() {
    ...
    const itemsInCart = () => {
        ...
        for (let i = 0; i < items.length; i++) { 
            console.log(i)
            stars.push(
                <div key={i} className="justify-between mb-6 rounded-lg bg-slate-100 p-6 shadow-md sm:flex sm:justify-start">
                    ...
                    <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                        <div className="mt-5 sm:mt-0">
                            <h2 className="text-lg font-bold text-gray-900">Nike Air Max 2019 id:{items[i]}</h2>
    ...
    return (
        <>
            <div className="h-screen bg-slate-50 pt-20">
